...
애님블루프린트에서 본의 트랜스폼을 조정한 후, **2본 IK 노드**를 활용해 본의 위치와 회전을 자연스럽게 보정한다.  
...
이를 캐릭터의 전방 및 우측 벡터와 각각 내적하여 공격 방향의 상대적 각도를 구하고

이를 통해 공격이 발생한 방향을 판별한다.

이 방향에 따라 다른 몽타주를 재생하게 된다.
